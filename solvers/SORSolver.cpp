      ...
      for (int k = 2; k < nz + 2; k++) {
        for (int j = 2; j < ny + 2; j++) {
          for (int i = 2; i < nx + 2; i++) {
            ...
            P.getScalar(i, j, k) =
                omg / a_C * (_flowField.getRHS().getScalar(i, j, k) -
                             a_W * P.getScalar(i - 1, j, k) -
                             a_E * P.getScalar(i + 1, j, k) -
                             a_S * P.getScalar(i, j - 1, k) -
                             a_N * P.getScalar(i, j + 1, k) -
                             a_B * P.getScalar(i, j, k - 1) -
                             a_T * P.getScalar(i, j, k + 1)) +
