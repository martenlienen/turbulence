...
void PeriodicBoundaryVelocityStencil::applyLeftWall(FlowField& flowField, int i,
                                                    int j) {
...
void PeriodicBoundaryVelocityStencil::applyRightWall(FlowField& flowField,
                                                     int i, int j) {
...
void PeriodicBoundaryVelocityStencil::applyBottomWall(FlowField& flowField,
                                                      int i, int j) {
...
void PeriodicBoundaryVelocityStencil::applyTopWall(FlowField& flowField, int i,
                                                   int j) {
...
void PeriodicBoundaryVelocityStencil::applyFrontWall(FlowField& flowField,
                                                     int i, int j, int k) {
...
void PeriodicBoundaryVelocityStencil::applyBackWall(FlowField& flowField, int i,
                                                    int j, int k) {
...
PeriodicBoundaryFGHStencil::PeriodicBoundaryFGHStencil(
    const Parameters& parameters)
    : BoundaryStencil<FlowField>(parameters) {}

// 2D problem
void PeriodicBoundaryFGHStencil::applyLeftWall(FlowField& flowField, int i,
                                               int j) {}
void PeriodicBoundaryFGHStencil::applyRightWall(FlowField& flowField, int i,
                                                int j) {}
void PeriodicBoundaryFGHStencil::applyBottomWall(FlowField& flowField, int i,
                                                 int j) {}
void PeriodicBoundaryFGHStencil::applyTopWall(FlowField& flowField, int i,
                                              int j) {}
...
void PeriodicBoundaryFGHStencil::applyTopWall(FlowField& flowField, int i,
                                              int j, int k) {}
void PeriodicBoundaryFGHStencil::applyFrontWall(FlowField& flowField, int i,
                                                int j, int k) {}
