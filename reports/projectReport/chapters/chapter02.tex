...
\item time discretization: mixed treatment (pressure implicit with backwards euler; velocity, turbulent kinetic energy and dissipation rate explicit - see Griebel)
\item 
\end{itemize}
