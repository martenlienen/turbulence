...
class SymmetryVelocityBoundaryStencil : public BoundaryStencil<FlowField> {
 public:
  /** Constructor
   * @param parameters Parameters of the simulation
   */
  SymmetryVelocityBoundaryStencil(const Parameters& parameters);
...
class SymmetryFGHBoundaryStencil : public BoundaryStencil<FlowField> {
 public:
  /** Constructor
   * @param parameters Parameters of the simulation
   */
  SymmetryFGHBoundaryStencil(const Parameters& parameters);
