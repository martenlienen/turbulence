 ...
 * meshsize afterwards.
 *  This, however, becomes inconsistent when dealing with non-uniform, e.g.
 * stretched, meshes, since
 *  the meshsize may be different for every grid cell. We therefore determine
 * the max(velocity)/meshsize
 *  and synchronise this value over whole computational domain.
 *  @author Philipp Neumann
 */
class MaxUStencil : public FieldStencil<FlowField>,
                    public BoundaryStencil<FlowField> {
 private:
