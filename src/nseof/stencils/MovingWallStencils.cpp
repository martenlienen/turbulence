...
void MovingWallVelocityStencil::applyLeftWall(FlowField& flowField, int i,
                                              int j) {
...
void MovingWallVelocityStencil::applyRightWall(FlowField& flowField, int i,
                                               int j) {
...
void MovingWallVelocityStencil::applyBottomWall(FlowField& flowField, int i,
                                                int j) {
...
void MovingWallVelocityStencil::applyTopWall(FlowField& flowField, int i,
                                             int j) {
  flowField.getVelocity().getVector(i, j)[0] =
...
void MovingWallVelocityStencil::applyLeftWall(FlowField& flowField, int i,
  ...
  flowField.getVelocity().getVector(i, j, k)[2] =
      2 * _parameters.walls.vectorLeft[2] -
...
void MovingWallVelocityStencil::applyBottomWall(FlowField& flowField, int i,
  ...
  flowField.getVelocity().getVector(i, j, k)[1] =
      _parameters.walls.vectorBottom[1];
  flowField.getVelocity().getVector(i, j, k)[2] =
      2 * _parameters.walls.vectorBottom[2] -
...
void MovingWallVelocityStencil::applyFrontWall(FlowField& flowField, int i,
                                               int j, int k) {
  flowField.getVelocity().getVector(i, j, k)[0] =
      2 * _parameters.walls.vectorFront[0] -
      flowField.getVelocity().getVector(i, j, k + 1)[0];
  flowField.getVelocity().getVector(i, j, k)[1] =
      2 * _parameters.walls.vectorFront[1] -
      flowField.getVelocity().getVector(i, j, k + 1)[1];
  flowField.getVelocity().getVector(i, j, k)[2] =
      _parameters.walls.vectorFront[2];
}

void MovingWallVelocityStencil::applyBackWall(FlowField& flowField, int i,
                                              int j, int k) {
  flowField.getVelocity().getVector(i, j, k)[0] =
      2 * _parameters.walls.vectorBack[0] -
      flowField.getVelocity().getVector(i, j, k - 1)[0];
  flowField.getVelocity().getVector(i, j, k)[1] =
      2 * _parameters.walls.vectorBack[1] -
      flowField.getVelocity().getVector(i, j, k - 1)[1];
...
void MovingWallFGHStencil::applyFrontWall(FlowField& flowField, int i, int j,
                                          int k) {
  flowField.getFGH().getVector(i, j, k)[2] = _parameters.walls.vectorFront[2];
}

void MovingWallFGHStencil::applyBackWall(FlowField& flowField, int i, int j,
                                         int k) {
