...
class Field {
 protected:
  ...
  const int
      _size_x;  //! Size of the field in x direction, including ghost layers
  const int
      _size_y;  //! Size of the field in y direction, including ghost layers
  const int
      _size_z;  //! Size of the field in z direction, including ghost layers
