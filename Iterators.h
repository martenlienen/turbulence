...
class Iterator {
 ...
 public:
   ...
   */
  Iterator(FlowField& flowfield, const Parameters& parameters)
...
class FieldIterator : public Iterator<FlowField> {
 ...
 public:
  FieldIterator(FlowField& flowField, const Parameters& parameters,
                FieldStencil<FlowField>& stencil, int lowOffset = 0,
                int highOffset = 0);
...
class GlobalBoundaryIterator : public Iterator<FlowField> {
 private:
  ...
  BoundaryStencil<FlowField>&
      _leftWallStencil;  //! Stencil used on the left wall
  BoundaryStencil<FlowField>&
      _rightWallStencil;  //! Stencil used on the right wall
  BoundaryStencil<FlowField>&
      _bottomWallStencil;  //! Stencil used on the bottom wall
  BoundaryStencil<FlowField>& _topWallStencil;  //! Stencil used on the top wall
  BoundaryStencil<FlowField>&
      _frontWallStencil;  //! Stencil used on the front wall
  BoundaryStencil<FlowField>&
      _backWallStencil;  //! Stencil used on the back wall
 ...
 public:
  ...
  GlobalBoundaryIterator(FlowField& flowField, const Parameters& parameters,
                         BoundaryStencil<FlowField>& stencil, int lowOffset = 0,
                         int highOffset = 0);
